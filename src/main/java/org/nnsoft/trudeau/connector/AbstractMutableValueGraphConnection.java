 ...
 */
public abstract class AbstractMutableValueGraphConnection<V, E>
    implements MutableValueGraphConnection<V, E>
{

    private MutableValueGraphConnector<V, E> connector;

    /**
     * {@inheritDoc}
     */
    public final void connect( MutableValueGraphConnector<V, E> connector )
    {
     ...
     */
    protected final <A extends E> HeadVertexConnector<V> putEdgeValue( A arc )
    {
